...
public class SwaggerExampleValue {
    ...
    public static final String GET_JOIN_RESPONSE = "{\"code\":200,\"status\":\"OK\",\"data\": 1,\"message\":\"share or send 입장 확인 성공\"}";
    public static final String JOIN_RESPONSE = "{\"code\":200,\"status\":\"OK\",\"message\":\"share or send 입장 성공\"}";
    public static final String GET_WRITE_RESPONSE = "{\"code\":200,\"status\":\"OK\",\"data\": 1,\"message\":\"share or send 작성 확인 성공\"}";
